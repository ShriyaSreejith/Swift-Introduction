...
print(even % 2)
print(odd % 2)
print("I think we can use the remainder operator to determine if a number is odd or even as an even number would have 0 as the remainder and an odd number would have 1 as its remainder always.")
