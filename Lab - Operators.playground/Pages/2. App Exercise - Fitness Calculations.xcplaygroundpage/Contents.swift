...
print(averageHRD)
print("Yes it differs from the previous average as this is a Double value and the previous one was an integer value. So this one would have a float as an answer while the previous one would have a whole number")
