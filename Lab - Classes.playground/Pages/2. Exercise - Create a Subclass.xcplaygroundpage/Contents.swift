...
print("We can't print falcon.weapon because falcon is just a Spaceship. Only Fighter has a weapon property, so Spaceship doesn't know anything about weapons.")
