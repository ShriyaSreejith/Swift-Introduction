...
if let daysJanuary = month["January"]{
    print("January has \(daysJanuary) days")
}else{
    print("No value for January found.")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["Triangle", "Square", "Rectangle", "Cone"]
var colorsArray = ["Blue", "Green", "Red", "Yellow"]
...
if let lastElement = dictionary["Colors"]{
    print(lastElement[3])
}
