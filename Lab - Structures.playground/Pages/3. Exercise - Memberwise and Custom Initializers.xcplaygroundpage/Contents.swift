...
var favoriteBook = Book(title: "Harry Potter", author: "J. K. Rowling", pages: 452, price: 20.99)
print("My favorile book is \(favoriteBook.title), which was written by the author \(favoriteBook.author). It's \(favoriteBook.pages) pages long and it cost me $\(favoriteBook.price)")
/*:
...
let laptop1 = Laptop(yearPurchased:2015)
let laptop2 = Laptop(screenSize: 15, repairCount: 3, yearPurchased: 2018)
/*:
