...
var Shriya = User(name: "Shriya", age: 16, height: 170, weight: 53.7, activityLevel: 7)
print("I am \(Shriya.name). I am \(Shriya.age) years old. My height is \(Shriya.height)cm and my weight is \(Shriya.weight) kgs. My activity level is \(Shriya.activityLevel).")
...
struct Distance{
    ...
    init(inches: Double){
        self.inches = inches
        self.meters = inches * 0.0254
        self.feet = inches * 0.0833333
    }
}
