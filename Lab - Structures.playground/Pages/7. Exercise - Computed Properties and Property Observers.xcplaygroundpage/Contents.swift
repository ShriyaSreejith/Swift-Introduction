...
struct Height {
    var heightInInches: Double{
        didSet {
            let rightCentimeters = heightInInches * 2.54
            if rightCentimeters != heightInCentimeters{
                heightInCentimeters = rightCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double{
        didSet {
            let rightInches = heightInCentimeters / 2.54
            if rightInches != heightInInches{
                heightInInches = rightInches
            }
        }
    }
