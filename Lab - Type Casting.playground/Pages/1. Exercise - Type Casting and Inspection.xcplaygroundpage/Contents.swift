 ...
 */
var collection:[Any] = [21.3,32.4, 54, 98, 21, "Hello", "Apple", "Math", true, false]
print(collection)
...
var myDict:[String:Any] = ["age":16,"Name":"Shriya", "GPA":4.3, "Happy": true ]
print(myDict)
...
for item in collection{
    if let intItem = item as? Int{
        ...
        if let convertStr = Double(strItem){
            total2 += convertStr
        }
    }
}
